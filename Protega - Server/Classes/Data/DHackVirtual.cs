...
namespace Protega___Server.Classes.Data
{
    class DHackVirtual
    {
        ...
        static private SqlParameter[] RegisterSqlParameter(EHackVirtual p_oData)
        {
            ...
            arParams[0].Value = p_oData.ApplicationName;
        ...
        public static bool Insert(EHackVirtual _pdata)
        {
            ...
            try
            {
                ...
                //Call the request
                oReader = CCstDatabase.DatabaseEngine.ExecuteReader(CommandType.StoredProcedure, CCstDatabase.SP_HackDetection_Insert_VirtualMemory, p_sqlParams);
